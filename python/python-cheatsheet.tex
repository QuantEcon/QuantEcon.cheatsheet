...
\begin{longtable}{ | m{6cm}  | m{11cm} |}
	...
	\textbf{Command} & \textbf{Description} \\
	\hline
	\mintinline{python}{np.array(object, dtype = None)} & {\mintinline{python}{np.array}} constructs a numpy array from an object, such as a list or a list of lists.  {\verb dtype } allows you to specify the type of object the array is holding.  You will generally not need to specify the {\verb dtype }.  Examples:
	\begin{minted}{python}
